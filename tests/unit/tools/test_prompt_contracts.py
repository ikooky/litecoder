...
@pytest.mark.parametrize(
    ("spec", "fragments"),
    [
        (ReadFileTool.spec, ("relevant path", "focused inspection", "before proposing")),
        ...
        (RunShellTool.spec, ("tests, builds", "dedicated tool", "never replay")),
        (SpawnSubagentTool.spec, ("bounded", "expected deliverable", "self-contained")),
        (TeamCreateTool.spec, ("independently scoped", "least-privilege", "validation standard")),
